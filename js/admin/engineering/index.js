...
function deleteAllPhotos() {
    if(confirm("Вы действительно хотите удалить все дополнительные фотографии?")) {
        ...
        if(id !== '') {
                ...
                success: function (response) {
                    switch(response) {
                        ...
                        case "failed":
                            ...
                            break;
                        case "id":
                            $.notify("Услуги с таким ID не существует.", "error");
                            break;
                        default:
                            $.notify(response, "warn");
                            break;
            ...
            $.notify("Вы не выбрали услугу.", "error");
        }
    }
}
                ...
                success: function (response) {
                    switch(response) {
                        case "ok":
                            ...
                            break;
                        case "failed":
                            $.notify("Во время удаления услуги произошла ошибка. Попробуйте снова.", "error");
                            break;
                        case "id":
                            $.notify("Услуги с таким ID не существует.", "error");
                            break;
