...
<div id="content">
    ...
    <form method="post" id="goodForm">
        ...
        <br /><br />
        <input type='button' id='addGoodSubmit' value='Добавить изделие' onmouseover='buttonHover("addGoodSubmit", 1)' onmouseout='buttonHover("addGoodSubmit", 0)' onclick='window.location.href = "/admin/study/add.php"' class='button' />
