...
<head>
    ...
    <title>Панель администрирования | Добавление записей в блог</title>
...
<body>
    ...
    <div id="content">
        <span class="headerFont">Добавление записей в блог</span>
        <br /><br />
        <input type='button' id='editPostSubmit' value='Редактирование записей' onmouseover='buttonHover("editPostSubmit", 1)' onmouseout='buttonHover("editPostSubmit", 0)' onclick='window.location.href = "/admin/blog"' class='button' />
        <br /><br />
            ...
            <?php
                if(!empty($_REQUEST['c'])) {
                    echo "
                        ...
                        <br /><br />
                        <div style='width: 100%;'>
                            <input type='button' id='addSubmit' value='Добавить' onmouseover='buttonHover(\"addSubmit\", 1)' onmouseout='buttonHover(\"addSubmit\", 0)' onclick='addPost()' class='button' />
                        </div>
                    ";
                }
            ?>
