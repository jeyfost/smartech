...
<head>
    ...
    <title>Панель администрирования | Internet of Things</title>
    ...
    <script type="text/javascript" src="/js/admin/iot/index.js"></script>
...
<div id="content">
    ...
    <form method="post" id="goodForm">
        ...
        <br /><br />
        <input type='button' id='addGoodSubmit' value='Добавить изделие' onmouseover='buttonHover("addGoodSubmit", 1)' onmouseout='buttonHover("addGoodSubmit", 0)' onclick='window.location.href = "/admin/iot/add.php"' class='button' />
