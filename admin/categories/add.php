...
<head>
    ...
    <title>Панель администрирования | Добавление разделов в магазине</title>
...
<body>
    ...
    <div id="content">
        <span class="headerFont">Добавление разделов в магазине</span>
        <br /><br />
        <input type='button' id='editCategorySubmit' value='Редактировать разделы' onmouseover='buttonHover("editCategorySubmit", 1)' onmouseout='buttonHover("editCategorySubmit", 0)' onclick='window.location.href = "/admin/categories"' class='button' />
        <br /><br />
            ...
            <?php
                if(empty($_REQUEST['c'])) {
                    echo "
                        ...
                        <br />
                        <input id='categoryNameInput' name='categoryName' />
                        <br /><br />
                        <label for='categoryURLInput'>URL раздела:</label>
                        <br />
                        <input id='categoryURLInput' name='categoryURL' />
                        <br /><br />
                        <input type='button' id='addSubmit' value='Добавить' onmouseover='buttonHover(\"addSubmit\", 1)' onmouseout='buttonHover(\"addSubmit\", 0)' onclick='addCategory()' class='button' />
                    ";
                } else {
                    echo "
                        <label for='subcategoryNameInput'>Название подраздела:</label>
                        <br />
                        <input id='subcategoryNameInput' name='subcategoryName' />
                        <br /><br />
                        <label for='subcategoryURLInput'>URL подраздела:</label>
                        <br />
                        <input id='subcategoryURLInput' name='subcategoryURL' />
                        <br /><br />
                        <input type='button' id='addSubmit' value='Добавить' onmouseover='buttonHover(\"addSubmit\", 1)' onmouseout='buttonHover(\"addSubmit\", 0)' onclick='addSubcategory()' class='button' />
                    ";
                }
            ?>
        </form>
