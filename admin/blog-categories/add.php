...
<head>
    ...
    <title>Панель администрирования | Добавление разделов блога</title>
    ...
    <script type="text/javascript" src="/js/admin/blog-categories/add.js"></script>
...
<div id="content">
    <span class="headerFont">Добавление разделов блога</span>
    <br /><br />
    <input type='button' id='editCategorySubmit' value='Редактировать разделы' onmouseover='buttonHover("editCategorySubmit", 1)' onmouseout='buttonHover("editCategorySubmit", 0)' onclick='window.location.href = "/admin/blog-categories"' class='button' />
    <br /><br />
