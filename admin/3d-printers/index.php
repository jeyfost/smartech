...
<head>
    ...
    <title>Панель администрирования | 3D-принтеры</title>
    ...
    <script type="text/javascript" src="/js/admin/3d-printers/index.js"></script>
...
<div id="content">
    <span class="headerFont">Редактирование 3D-принтеров</span>
    <br /><br />
    <form method="post" id="goodForm">
        ...
        <br /><br />
        <input type='button' id='addGoodSubmit' value='Добавить принтер' onmouseover='buttonHover("addGoodSubmit", 1)' onmouseout='buttonHover("addGoodSubmit", 0)' onclick='window.location.href = "/admin/3d-printers/add.php"' class='button' />
        ...
        <?php
            if(!empty($_REQUEST['id'])) {
                echo "
                    ...
                    <hr />
                    <br /><br />
                    <span class='headerFont'>Редактирование 3D-принтера <span style='color: #939393;'>&laquo;".$good['name']."&raquo;</span></span>
                    <br /><br />
                    <label for='nameInput'>Название принтера:</label>
                    <br />
