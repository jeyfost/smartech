...
<head>
    ...
    <script type="text/javascript" src="/js/admin/3d-print/index.js"></script>
...
<div id="content">
    <span class="headerFont">Редактирование изделий</span>
    <br /><br />
    <form method="post" id="goodForm">
        ...
        <br /><br />
        <input type='button' id='addGoodSubmit' value='Добавить изделие' onmouseover='buttonHover("addGoodSubmit", 1)' onmouseout='buttonHover("addGoodSubmit", 0)' onclick='window.location.href = "/admin/3d-print/add.php"' class='button' />
        ...
        if(!empty($_REQUEST['id'])) {
            echo "
                    ...
                    <hr />
                    <br /><br />
                    <span class='headerFont'>Редактирование изделия <span style='color: #939393;'>&laquo;".$good['name']."&raquo;</span></span>
                    <br /><br />
